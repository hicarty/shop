  ...
  static get template() {
    ...
    <app-header role="navigation" id="header" effects="waterfall" condenses="" reveals="">
      <app-toolbar>
        ...
        <div class="logo" main-title=""><a href="/" aria-label="SHOP Home">HAVEN CARTY DESIGN</a></div>
    ...
    <footer>
      <a href="https://www.instagram.com/hicarty/" target="_blank">Instagram</a>
      <div class="demo-label">PORTFOLIO</div>
    </footer>
